...
ActiveRecord::Schema[8.0].define(version: 2025_10_30_193642) do
  ...
  create_table "pricing_tiers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "word_count", "price_cents", "currency"], name: "index_pricing_tiers_on_user_and_details", unique: true
